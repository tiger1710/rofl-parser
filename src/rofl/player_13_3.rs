...
pub struct Player {
    pub ALL_IN_PINGS: String,
    pub ASSISTS: String,
    pub ASSIST_ME_PINGS: String,
    pub BAIT_PINGS: String,
    pub BARON_KILLS: String,
    pub BARRACKS_KILLED: String,
    pub BARRACKS_TAKEDOWNS: String,
    pub BASIC_PINGS: String,
    ...
    pub COMMAND_PINGS: String,
    pub CONSUMABLES_PURCHASED: String,
    pub DANGER_PINGS: String,
    pub DOUBLE_KILLS: String,
    pub DRAGON_KILLS: String,
    pub ENEMY_MISSING_PINGS: String,
    pub ENEMY_VISION_PINGS: String,
    pub EXP: String,
    ...
    pub GET_BACK_PINGS: String,
    pub GOLD_EARNED: String,
    pub GOLD_SPENT: String,
    pub HOLD_PINGS: String,
    ...
    pub LARGEST_ABILITY_DAMAGE: String,
    pub LARGEST_ATTACK_DAMAGE: String,
    ...
    pub PUSH_PINGS: String,
    pub PUUID: String,
    pub QUADRA_KILLS: String,
    pub RETREAT_PINGS: String,
    pub RIFT_HERALD_KILLS: String,
    ...
    pub TOTAL_TIME_CROWD_CONTROL_DEALT_TO_CHAMPIONS: String,
    ...
    pub VISION_CLEARED_PINGS: String,
